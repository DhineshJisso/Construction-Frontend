...
const Footer = () => {
  return (
    <footer className="w-full relative mt-24">
      {/* Newsletter Section */}
      <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-[95%] md:w-[80%] bg-orange-600 rounded-lg shadow-xl 
                      flex flex-col md:flex-row items-center justify-between gap-4 text-white p-6 z-30">
        <img className="w-12 md:w-16" src={Mail} alt="Mail send" />

        <h1 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-center md:text-left flex-1">
          Subscribe Our Newsletter
        </h1>

        <div className="flex w-full items-center justify-center md:w-auto gap-2 ">
          <input
            className="flex-1 bg-white text-black px-4 py-2 rounded-md focus:outline-none text-sm sm:text-base"
            type="email"
            placeholder="Email Address"
          />
          <button className="bg-black px-4 sm:px-6 py-2 rounded-md font-bold text-sm sm:text-base hover:bg-gray-800 transition">
            Submit
          </button>
        </div>
      </div>
      ...
      {/* Main Footer */}
      <section
        className="relative text-white pt-28 md:pt-32"
        style={{
          backgroundImage: "url('/download (6).jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
      ...
      >
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 p-6 md:px-16 lg:px-20 z-10">
          {/* Brand */}
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold">
              LOGI<span className="text-orange-600">LAND</span>
            </h1>
            <p className="py-4 leading-relaxed text-sm md:text-base">
              A farm is a plot of land that is used to grow crops and raise
              livestock, as in our farm, we raise sheep and sell their wool.
            </p>
            <div className="flex gap-3 text-xl md:text-2xl mt-2">
              <FaFacebookF className="bg-white p-2 rounded text-orange-600 hover:text-white hover:bg-orange-600 transition" />
              <LuInstagram className="bg-white p-2 rounded text-orange-600 hover:text-white hover:bg-orange-600 transition" />
              <BsTwitterX className="bg-white p-2 rounded text-orange-600 hover:text-white hover:bg-orange-600 transition" />
              <FaLinkedinIn className="bg-white p-2 rounded text-orange-600 hover:text-white hover:bg-orange-600 transition" />
            </div>
          </div>

          {/* Services */}
          <div>
            <h1 className="text-lg md:text-xl font-bold pb-3">Our Services</h1>
            {[
              "Warehouse Air",
              "Freight Ocean",
              "Freight Road",
              ...
              <p key={i} className="flex items-center py-1 text-sm md:text-base">
                <FaPlus className="me-2 text-orange-500" /> {service}
              </p>
            ))}
          </div>
          ...
          {/* Links */}
          <div>
            <h1 className="text-lg md:text-xl font-bold pb-3">Useful Links</h1>
            {[
              "News & Media",
              "Sustainability",
              "About Expertise",
              ...
              <p key={i} className="flex items-center py-1 text-sm md:text-base">
                <FaPlus className="me-2 text-orange-500" /> {link}
              </p>
            ))}
          </div>
          ...
          {/* Contact */}
          <div>
            <h1 className="text-lg md:text-xl font-bold pb-3">Contact Info</h1>
            <p className="flex items-center py-2 text-sm md:text-base">
              <IoLocationOutline className="text-2xl md:text-3xl text-orange-600 bg-white hover:text-white hover:bg-orange-600 rounded-full p-2 me-3 transition" />
              Egmore, Chennai.
            </p>
            <p className="flex items-center py-2 text-sm md:text-base">
              <IoCallOutline className="text-2xl md:text-3xl text-orange-600 bg-white hover:text-white hover:bg-orange-600 rounded-full p-2 me-3 transition" />
              +91 9042696983
            </p>
            <p className="flex items-center py-2 text-sm md:text-base">
              <CgMail className="text-2xl md:text-3xl text-orange-600 bg-white hover:text-white hover:bg-orange-600 rounded-full p-2 me-3 transition" />
              whytap@gmail.com
            </p>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-2 px-6 md:px-20 py-4 bg-indigo-950 bg-opacity-70 text-xs sm:text-sm z-10">
          <p className="text-center md:text-left">
            © 2025 ThemeJunction. All Rights Reserved.
          </p>
          <div className="flex flex-wrap gap-4 text-center md:text-left">
            <p className="cursor-pointer hover:text-orange-400">Setting & Privacy</p>
            <p className="cursor-pointer hover:text-orange-400">Faqs</p>
            <p className="cursor-pointer hover:text-orange-400">Support</p>
          </div>
        </div>
      </section>
    </footer>
